...
YuvFrame *VideoEncode::rgba_convert_i420(char *frame, int width, int height, bool need_flip, int rotate_degree) {
    return convert.rgba_convert_i420(frame, width, height, need_flip, rotate_degree);
}

YuvFrame *VideoEncode::rgba_convert_nv12(char *frame, int width, int height, bool need_flip,
                                         int rotate_degree) {
