...
public final class VideoConfiguration {
  ...
  private VideoConfiguration(final Builder builder) {
    ...
    ifi = builder.ifi;
    mime = builder.mime;
    encoder = builder.isSoftEncoder ? new SoftEncoder() : new HardEncoder();
  }
  ...
  public static class Builder {
    ...
    private boolean isSoftEncoder = false;
    ...
    public Builder isSoftEncoder(boolean isSoftEncoder) {
      this.isSoftEncoder = isSoftEncoder;
      return this;
    }
